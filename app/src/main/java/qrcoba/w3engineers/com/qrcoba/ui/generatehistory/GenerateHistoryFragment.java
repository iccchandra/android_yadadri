package qrcoba.w3engineers.com.qrcoba.ui.generatehistory;
...
import qrcoba.w3engineers.com.qrcoba.databinding.FragmentDownHistoryBinding;
...
public class GenerateHistoryFragment extends Fragment implements OnStartDragListener, ItemClickListener<Code> {

    private Context mContext;
    private FragmentDownHistoryBinding mBinding;
    ...
    private GenerateHistoryFragment() {

    }

    public static GenerateHistoryFragment newInstance() {
        return new GenerateHistoryFragment();
    }

    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        mBinding = DataBindingUtil.inflate(inflater, R.layout.fragment_down_history, container, false);
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        getCompositeDisposable().add(DatabaseUtil.on().getAllGeneratedCodes()
